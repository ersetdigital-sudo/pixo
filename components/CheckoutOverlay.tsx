            ...
            <div className="mt-4 rounded-2xl border border-emerald-400/20 bg-emerald-400/[.06] p-4 text-left">
              ...
              {waUrl ? (
                <a
                  ...
                  className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-400/15 py-2.5 text-xs font-bold text-emerald-400 transition hover:bg-emerald-400/25"
                >
