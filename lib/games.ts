...
export const GAMES: StaticGame[] = [
  {
    ...
    metaDescription: "Top up Mobile Legends di PIXOGAMEONLINE mulai Rp1.500. Dari 5 sampai 2.195 Diamond plus Weekly & Twilight Pass, langsung masuk ke User ID + Zone ID tanpa login akun.",
  ...
  },
  {
    ...
    metaDescription: "Top up Free Fire di PIXOGAMEONLINE mulai Rp1.500. Diamond FF cair cepat ke User ID kamu tanpa password atau OTP.",
  ...
  },
  {
    ...
    metaDescription: "Top up PUBG Mobile di PIXOGAMEONLINE mulai Rp15.000. UC resmi buat Royale Pass & crate, kirim ke User ID kamu tanpa login akun.",
  ...
  },
  {
    ...
    metaDescription: "Top up Call of Duty: Mobile di PIXOGAMEONLINE mulai Rp11.000. CP buat skin legendaris & Battle Pass, proses otomatis tanpa login akun.",
  ...
  },
  {
    ...
    metaDescription: "Top up Magic Chess: Go Go di PIXOGAMEONLINE mulai Rp4.500. Diamond & Pass buat push rank commander, tanpa registrasi atau login.",
