...
export default async function AdminGamesPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="display text-xl font-extrabold text-ink">Kelola Harga</h1>
        <p className="mt-1 text-sm text-muted">Edit nominal dan harga per game</p>
      </div>
      ...
      {games.length === 0 && !errorMsg && (
        <p className="text-sm text-muted text-center py-12">Belum ada game.</p>
      )}
